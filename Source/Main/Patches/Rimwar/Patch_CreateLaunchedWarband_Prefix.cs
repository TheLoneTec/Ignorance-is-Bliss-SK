...
// Type: DIgnoranceIsBliss.RimWar_Patches.Patch_CreateLaunchedWarband_Prefix
...
{
  [HarmonyPatch]
  internal class Patch_CreateLaunchedWarband_Prefix
  {
    private static MethodBase targetMethod;

    [HarmonyTargetMethod]
    internal static MethodBase TargetMethod() => Patch_CreateLaunchedWarband_Prefix.targetMethod;
    ...
    internal static bool Prepare()
    {
      if (RimWar_Compatibility.assembly == (Assembly) null)
        return false;
      Patch_CreateLaunchedWarband_Prefix.targetMethod = (MethodBase) AccessTools.Method(RimWar_Compatibility.assembly.GetType("RimWar.Planet.WorldUtility"), "CreateLaunchedWarband");
      return true;
    }
