...
// Type: DIgnoranceIsBliss.RimWar_Patches.Patch_CreateWarband_Prefix
...
{
  [HarmonyPatch]
  internal class Patch_CreateWarband_Prefix
  {
    private static MethodBase targetMethod;

    [HarmonyTargetMethod]
    internal static MethodBase TargetMethod() => Patch_CreateWarband_Prefix.targetMethod;
    ...
    internal static bool Prepare()
    {
      if (RimWar_Compatibility.assembly == (Assembly) null)
        return false;
      Patch_CreateWarband_Prefix.targetMethod = (MethodBase) AccessTools.Method(RimWar_Compatibility.assembly.GetType("RimWar.Planet.WorldUtility"), "CreateWarband");
      return true;
    }
